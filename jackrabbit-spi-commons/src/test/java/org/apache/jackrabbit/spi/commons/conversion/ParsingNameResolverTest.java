...
/**
 * Test cases for the
 * {@link org.apache.jackrabbit.conversion.ParsingNameResolver} class.
 */
public class ParsingNameResolverTest extends TestCase {
	 ...
	 */
	private NameResolver resolver = new ParsingNameResolver(NameFactoryImpl.getInstance(),
			DummyNamespaceResolver.mockNamespaceResolver1());

	/**
	 * Checks that the given name resolves to the given namespace URI and local
	 * part.
	 *
	 * @param name  JCR name
