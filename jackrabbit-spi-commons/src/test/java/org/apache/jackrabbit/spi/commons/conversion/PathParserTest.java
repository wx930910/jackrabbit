...
public class PathParserTest extends TestCase {
	...
	public NamespaceResolver mockNamespaceResolver1() {
	...
	public PathParserTest() {
		resolver = new ParsingNameResolver(NameFactoryImpl.getInstance(),
				DummyNamespaceResolver.mockNamespaceResolver1());
