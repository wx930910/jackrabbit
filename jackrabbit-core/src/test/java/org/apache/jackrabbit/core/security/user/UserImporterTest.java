...
public class UserImporterTest extends AbstractJCRTest {
	...
	public ImportConfig mockImportConfig1() {
		UserImporter mockFieldVariableUserImporter;
		ImportConfig mockInstance = spy(ImportConfig.class);
		mockFieldVariableUserImporter = createImporter();
		doAnswer((stubInvo) -> {
			return Collections.singletonList(mockFieldVariableUserImporter);
		}).when(mockInstance).getProtectedItemImporters();
		return mockInstance;
	}

	public ImportConfig mockImportConfig2(int importBehavior) {
		UserImporter mockFieldVariableUserImporter;
		ImportConfig mockInstance = spy(ImportConfig.class);
		mockFieldVariableUserImporter = createImporter();
		(mockFieldVariableUserImporter).setImportBehavior(ImportBehavior.nameFromValue(importBehavior));
		doAnswer((stubInvo) -> {
			return Collections.singletonList(mockFieldVariableUserImporter);
		}).when(mockInstance).getProtectedItemImporters();
		return mockInstance;
		...
		if (umgr.isAutoSave()) {
			try {
				...
				throw new NotExecutableException(
						"Expected user manager that can have its autosave behavior changed to false.");
			}
		}
	...
	public void testWorkspaceImport() {
		assertFalse("WorkspaceImport is not supported -> init should return false.", createImporter().init(sImpl, sImpl,
				true, ImportUUIDBehavior.IMPORT_UUID_COLLISION_THROW, new ReferenceChangeTracker()));
	}
	...
	public void testUUIDBehaviorCreateNew() {
		assertFalse("ImportUUIDBehavior.IMPORT_UUID_CREATE_NEW is not supported -> init should return false.",
				createImporter().init(sImpl, sImpl, false, ImportUUIDBehavior.IMPORT_UUID_CREATE_NEW,
						new ReferenceChangeTracker()));
	}

	public void testDifferentUserManagerImpl() {
		assertFalse("Only UserManagerImpl supported", createImporter().init(new DummySession(), sImpl, false,
				ImportUUIDBehavior.IMPORT_UUID_COLLISION_THROW, new ReferenceChangeTracker()));
	}

	public void testInitTwice() {
		UserImporter userImporter = createImporter();
		assertTrue(userImporter.init(sImpl, sImpl, false, ImportUUIDBehavior.IMPORT_UUID_COLLISION_THROW,
				new ReferenceChangeTracker()));
		try {
			userImporter.init(sImpl, sImpl, false, ImportUUIDBehavior.IMPORT_UUID_COLLISION_THROW,
					new ReferenceChangeTracker());
	...
	public void testImportUser() throws RepositoryException, IOException, SAXException, NotExecutableException {
		...
		try {
			...
			assertEquals("{sha1}8efd86fb78a56a5145ed7739dcb00c78581c5375",
					n.getProperty(UserConstants.P_PASSWORD).getString());
	...
	public void testImportGroupIntoUsersTree()
		...
		/*
		 * importing a group below the users-path: - nonProtected node rep:Group must be
		 * created. - protected properties are ignored - UserManager.getAuthorizable
		 * must return null. - saving changes must fail with ConstraintViolationEx.
		 */
	...
	public void testImportAuthorizableId()
			throws IOException, RepositoryException, SAXException, NotExecutableException {
		...
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				+ "<sv:node sv:name=\"t\" xmlns:mix=\"http://www.jcp.org/jcr/mix/1.0\" xmlns:nt=\"http://www.jcp.org/jcr/nt/1.0\" xmlns:fn_old=\"http://www.w3.org/2004/10/xpath-functions\" xmlns:fn=\"http://www.w3.org/2005/xpath-functions\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:sv=\"http://www.jcp.org/jcr/sv/1.0\" xmlns:rep=\"internal\" xmlns:jcr=\"http://www.jcp.org/jcr/1.0\">"
				+ "   <sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\"><sv:value>rep:User</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"jcr:uuid\" sv:type=\"String\"><sv:value>" + mismatchUUID
	...
	public void testExistingPrincipal() throws RepositoryException, NotExecutableException, IOException, SAXException {
		...
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				...
				+ "   <sv:property sv:name=\"jcr:uuid\" sv:type=\"String\"><sv:value>e358efa4-89f5-3062-b10d-d7316b65649e</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"rep:password\" sv:type=\"String\"><sv:value>{sha1}8efd86fb78a56a5145ed7739dcb00c78581c5375</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"rep:principalName\" sv:type=\"String\"><sv:value>" + existing.getName()
	...
	public void testConflictingPrincipalsWithinImport()
			throws IOException, RepositoryException, NotExecutableException {
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<sv:node sv:name=\"g\" xmlns:mix=\"http://www.jcp.org/jcr/mix/1.0\" xmlns:nt=\"http://www.jcp.org/jcr/nt/1.0\" xmlns:fn_old=\"http://www.w3.org/2004/10/xpath-functions\" xmlns:fn=\"http://www.w3.org/2005/xpath-functions\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:sv=\"http://www.jcp.org/jcr/sv/1.0\" xmlns:rep=\"internal\" xmlns:jcr=\"http://www.jcp.org/jcr/1.0\">"
				+ "   <sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\"><sv:value>rep:Group</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"jcr:uuid\" sv:type=\"String\"><sv:value>b2f5ff47-4366-31b6-a533-d8dc3614845d</sv:value></sv:property>"
	...
	public void testMultiValuedPrincipalName()
			throws RepositoryException, IOException, SAXException, NotExecutableException {
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<sv:node sv:name=\"g\" xmlns:mix=\"http://www.jcp.org/jcr/mix/1.0\" xmlns:nt=\"http://www.jcp.org/jcr/nt/1.0\" xmlns:fn_old=\"http://www.w3.org/2004/10/xpath-functions\" xmlns:fn=\"http://www.w3.org/2005/xpath-functions\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:sv=\"http://www.jcp.org/jcr/sv/1.0\" xmlns:rep=\"internal\" xmlns:jcr=\"http://www.jcp.org/jcr/1.0\">"
				+ "   <sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\"><sv:value>rep:Group</sv:value></sv:property>"
		 ...
		 * nonProtected node rep:Group must be created. - property rep:principalName
		 * must be created regularly without being protected - saving changes must fail
		 * with ConstraintViolationEx. as the protected mandatory property
		 * rep:principalName is missing
		 */
		NodeImpl target = (NodeImpl) sImpl.getNode(umgr.getGroupsPath());
		try {
			doImport(target, xml);
	...
	public void testPlainTextPassword() throws RepositoryException, IOException, SAXException, NotExecutableException {
		...
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				...
				+ "   <sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\"><sv:value>rep:User</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"jcr:uuid\" sv:type=\"String\"><sv:value>e358efa4-89f5-3062-b10d-d7316b65649e</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"rep:password\" sv:type=\"String\"><sv:value>" + plainPw
				+ "</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"rep:principalName\" sv:type=\"String\"><sv:value>t</sv:value></sv:property>"
				+ "</sv:node>";
	...
	public void testMultiValuedPassword()
			throws RepositoryException, IOException, SAXException, NotExecutableException {
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<sv:node sv:name=\"t\" xmlns:mix=\"http://www.jcp.org/jcr/mix/1.0\" xmlns:nt=\"http://www.jcp.org/jcr/nt/1.0\" xmlns:fn_old=\"http://www.w3.org/2004/10/xpath-functions\" xmlns:fn=\"http://www.w3.org/2005/xpath-functions\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:sv=\"http://www.jcp.org/jcr/sv/1.0\" xmlns:rep=\"internal\" xmlns:jcr=\"http://www.jcp.org/jcr/1.0\">"
				+ "   <sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\"><sv:value>rep:User</sv:value></sv:property>"
				...
				+ "</sv:node>";
		/*
		 * importing a user with a multi-valued rep:password property - nonProtected
		 * node rep:User must be created. - property rep:password must be created
		 * regularly without being protected - saving changes must fail with
		 * ConstraintViolationEx. as the protected mandatory property rep:password is
		 * missing
		 */
		NodeImpl target = (NodeImpl) sImpl.getNode(umgr.getUsersPath());
		try {
	...
	public void testIncompleteGroup() throws IOException, RepositoryException, SAXException, NotExecutableException {
		...
		/*
		 * importing a group without rep:principalName property - saving changes must
		 * fail with ConstraintViolationEx.
		 */
		NodeImpl target = (NodeImpl) sImpl.getNode(umgr.getGroupsPath());
		try {
			doImport(target, xml);
	...
	public void testImportWithIntermediatePath()
			throws IOException, RepositoryException, SAXException, NotExecutableException {
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				...
				+ "</sv:node>" + "</sv:node>" + "</sv:node>" + "</sv:node>";
	...
	public void testImportNewMembers() throws IOException, RepositoryException, SAXException, NotExecutableException {
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				...
				+ "   <sv:value>rep:AuthorizableFolder</sv:value>" + "</sv:property>" + "<sv:node sv:name=\"g\">"
				+ "   <sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\"><sv:value>rep:Group</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"jcr:uuid\" sv:type=\"String\"><sv:value>b2f5ff47-4366-31b6-a533-d8dc3614845d</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"rep:principalName\" sv:type=\"String\"><sv:value>g</sv:value></sv:property>"
				+ "</sv:node>" + "<sv:node sv:name=\"g1\">"
				+ "   <sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\"><sv:value>rep:Group</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"jcr:uuid\" sv:type=\"String\"><sv:value>0120a4f9-196a-3f9e-b9f5-23f31f914da7</sv:value></sv:property>"
	...
	public void testImportNewMembersReverseOrder()
			throws IOException, RepositoryException, SAXException, NotExecutableException {
	...
	public void testImportMembers() throws RepositoryException, IOException, SAXException, NotExecutableException {
		...
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				...
				+ "       <sv:property sv:name=\"jcr:uuid\" sv:type=\"String\"><sv:value>0120a4f9-196a-3f9e-b9f5-23f31f914da7</sv:value></sv:property>"
				+ "       <sv:property sv:name=\"rep:principalName\" sv:type=\"String\"><sv:value>g1</sv:value></sv:property>"
				+ "       <sv:property sv:name=\"rep:members\" sv:type=\"WeakReference\"><sv:value>" + uuid
	...
	public void testImportNonExistingMemberIgnore()
			throws IOException, RepositoryException, SAXException, NotExecutableException {
	...
	public void testImportNonExistingMemberAbort()
			throws IOException, RepositoryException, SAXException, NotExecutableException {
		Node n = testRootNode.addNode(nodeName1, ntUnstructured);
		n.addMixin(mixReferenceable);
	...
	public void testImportNonExistingMemberBestEffort()
			throws IOException, RepositoryException, SAXException, NotExecutableException {
	...
	public void testImportNonExistingMemberBestEffort2()
			throws IOException, RepositoryException, SAXException, NotExecutableException {
		...
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				...
				+ "</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"rep:principalName\" sv:type=\"String\"><sv:value>g1</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"rep:members\" sv:type=\"WeakReference\"><sv:value>" + nonExistingId
				+ "</sv:value></sv:property>" + "</sv:node>" + "</sv:node>";

		String xml2 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				+ "   <sv:node sv:name=\"g\" xmlns:mix=\"http://www.jcp.org/jcr/mix/1.0\" xmlns:nt=\"http://www.jcp.org/jcr/nt/1.0\" xmlns:fn_old=\"http://www.w3.org/2004/10/xpath-functions\" xmlns:fn=\"http://www.w3.org/2005/xpath-functions\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:sv=\"http://www.jcp.org/jcr/sv/1.0\" xmlns:rep=\"internal\" xmlns:jcr=\"http://www.jcp.org/jcr/1.0\">"
				+ "       <sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\"><sv:value>rep:Group</sv:value></sv:property>"
				+ "       <sv:property sv:name=\"jcr:uuid\" sv:type=\"String\"><sv:value>" + nonExistingId
				+ "</sv:value></sv:property>"
				+ "       <sv:property sv:name=\"rep:principalName\" sv:type=\"String\"><sv:value>g</sv:value></sv:property>"
		...
		try {
			 ...
			 * references. expected: - group is imported - circular membership is ignored -
			 * g is member of g1 - g1 isn't member of g
			 */
	...
	public void testImportSelfAsGroupIgnore() throws Exception {
		...
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				...
				+ "</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"rep:principalName\" sv:type=\"String\"><sv:value>g1</sv:value></sv:property>"
				+ "   <sv:property sv:name=\"rep:members\" sv:type=\"WeakReference\"><sv:value>" + invalidId
				+ "</sv:value></sv:property>" + "</sv:node>" + "</sv:node>";
		NodeImpl target = (NodeImpl) sImpl.getNode(umgr.getGroupsPath());
		try {
			doImport(target, xml, UserImporter.ImportBehavior.IGNORE);
	...
	public void testImportImpersonation()
			throws IOException, RepositoryException, SAXException, NotExecutableException {
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
	...
	public void testImportInvalidImpersonationIgnore()
			throws IOException, RepositoryException, SAXException, NotExecutableException {
		List<String> invalid = new ArrayList<String>();
		...
		for (String principalName : invalid) {
			String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
					...
					+ "   <sv:property sv:name=\"jcr:uuid\" sv:type=\"String\"><sv:value>e358efa4-89f5-3062-b10d-d7316b65649e</sv:value></sv:property>"
					+ "   <sv:property sv:name=\"rep:password\" sv:type=\"String\"><sv:value>{sha1}8efd86fb78a56a5145ed7739dcb00c78581c5375</sv:value></sv:property>"
					+ "   <sv:property sv:name=\"rep:principalName\" sv:type=\"String\"><sv:value>t</sv:value></sv:property><sv:property sv:name=\"rep:impersonators\" sv:type=\"String\"><sv:value>"
					+ principalName + "</sv:value></sv:property>" + "</sv:node>";
			Subject subj = new Subject();
	...
	public void testImportInvalidImpersonationAbort()
			throws IOException, RepositoryException, SAXException, NotExecutableException {
		List<String> invalid = new ArrayList<String>();
		invalid.add("anybody"); // an non-existing princ-name
		invalid.add("administrators"); // a group
	...
	public void testImportUuidCollisionThrow() throws RepositoryException, IOException, SAXException {
		...
		try {
			...
			doImport(target, xml, ImportUUIDBehavior.IMPORT_UUID_COLLISION_THROW,
					UserImporter.ImportBehavior.BESTEFFORT);
	...
	public void testImportGroupMembersFromNodes() throws RepositoryException, IOException, SAXException {
		...
		try {
			String[] users = { "angi", "adi", "hansi", "lisi", "luzi", "susi", "pipi", "hari", "gabi", "eddi", "debbi",
					"cati", "admin", "anonymous" };
	...
	public void testActionExecutionForUser() throws Exception, RepositoryException {
		AuthorizableAction testAction = mock(AuthorizableAction.class);
		String[] testActionPw = new String[1];
		String[] testActionId = new String[1];
		doAnswer((stubInvo) -> {
			User user = stubInvo.getArgument(0);
			String password = stubInvo.getArgument(1);
			testActionId[0] = user.getID();
			testActionPw[0] = password;
			return null;
		}).when(testAction).onCreate(any(User.class), any(String.class), any(Session.class));
		doAnswer((stubInvo) -> {
			String newPassword = stubInvo.getArgument(1);
			testActionPw[0] = newPassword;
			return null;
		}).when(testAction).onPasswordChange(any(User.class), any(String.class), any(Session.class));
		doAnswer((stubInvo) -> {
			Group group = stubInvo.getArgument(0);
			testActionId[0] = group.getID();
			return null;
		}).when(testAction).onCreate(any(Group.class), any(Session.class));
		...
		try {
			doImport(target, xml);
			assertEquals(testActionId[0], "t");
			assertEquals(testActionPw[0], "pw");
		} finally {
			sImpl.refresh(false);
		}
	}

	public void testActionExecutionForGroup() throws Exception, RepositoryException {
		AuthorizableAction testAction = mock(AuthorizableAction.class);
		String[] testActionPw = new String[1];
		String[] testActionId = new String[1];
		doAnswer((stubInvo) -> {
		...
		try {
			doImport(target, xml);
			assertEquals(testActionId[0], "g");
			assertNull(testActionPw[0]);
		} finally {
			sImpl.refresh(false);
		}
	}
	...
	private void doImport(NodeImpl target, String xml, int importBehavior)
	...
	private void doImport(NodeImpl target, String xml, int uuidBehavior, int importBehavior)
			throws IOException, SAXException, RepositoryException {
		InputStream in = new ByteArrayInputStream(xml.getBytes("UTF-8"));
		SessionImporter importer = new SessionImporter(target, sImpl, uuidBehavior, mockImportConfig2(importBehavior));
		ImportHandler ih = new ImportHandler(importer, sImpl);
		new ParsingContentHandler(ih).parse(in);
	}
