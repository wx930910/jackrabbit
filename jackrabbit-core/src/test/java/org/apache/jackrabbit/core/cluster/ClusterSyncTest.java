...
public class ClusterSyncTest extends JUnitTest {
	...
	/**
	 * Verify that sync() on a cluster node will continue fetching results until no
	 ...
	 * @param disableAutoSync if <code>true</code> background synchronization is
	 *                        disabled
	 */
	private ClusterNode createClusterNode(String id, boolean disableAutoSync) throws Exception, RepositoryException {
	...
	/**
	 * Custom consumer that will block inside the journal's sync() method until it
	 * is unblocked.
	 */
