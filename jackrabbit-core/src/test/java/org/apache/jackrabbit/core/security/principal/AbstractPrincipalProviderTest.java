...
public class AbstractPrincipalProviderTest extends TestCase {
	...
	public AbstractPrincipalProvider mockAbstractPrincipalProvider1() throws Exception {
	...
	public void testNegativeCacheEntries() throws RepositoryException, NotExecutableException, Exception, Exception {
