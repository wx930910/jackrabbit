...
public class AccessControlImporterTest extends AbstractJCRTest {
	...
	public ImportConfig mockImportConfig1() throws Exception {
		ProtectedNodeImporter mockFieldVariableAci;
		ImportConfig mockInstance = Mockito.spy(ImportConfig.class);
		mockFieldVariableAci = createImporter();
		Mockito.doAnswer((stubInvo) -> {
			return Collections.singletonList(mockFieldVariableAci);
