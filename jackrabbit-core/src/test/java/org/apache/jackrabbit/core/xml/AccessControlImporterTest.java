...
public class AccessControlImporterTest extends AbstractJCRTest {
	...
	public ImportConfig mockImportConfig1() {
		ProtectedNodeImporter[] mockFieldVariableAci = new ProtectedNodeImporter[1];
		ImportConfig mockInstance = Mockito.spy(ImportConfig.class);
		mockFieldVariableAci[0] = createImporter();
		try {
			Mockito.doAnswer((stubInvo) -> {
				return Collections.singletonList(mockFieldVariableAci[0]);
	...
	private static final String XML_POLICY_TREE = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			...
			+ "<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\">" + "<sv:value>nt:unstructured</sv:value>"
			+ "</sv:property>" + "<sv:property sv:name=\"jcr:mixinTypes\" sv:type=\"Name\">"
			+ "<sv:value>rep:AccessControllable</sv:value>" + "<sv:value>mix:versionable</sv:value>" + "</sv:property>"
			+ "<sv:property sv:name=\"jcr:uuid\" sv:type=\"String\">"
			+ "<sv:value>0a0ca2e9-ab98-4433-a12b-d57283765207</sv:value>" + "</sv:property>"
			+ "<sv:property sv:name=\"jcr:baseVersion\" sv:type=\"Reference\">"
			+ "<sv:value>35d0d137-a3a4-4af3-8cdd-ce565ea6bdc9</sv:value>" + "</sv:property>"
			+ "<sv:property sv:name=\"jcr:isCheckedOut\" sv:type=\"Boolean\">" + "<sv:value>true</sv:value>"
			+ "</sv:property>" + "<sv:property sv:name=\"jcr:predecessors\" sv:type=\"Reference\">"
			+ "<sv:value>35d0d137-a3a4-4af3-8cdd-ce565ea6bdc9</sv:value>" + "</sv:property>"
			+ "<sv:property sv:name=\"jcr:versionHistory\" sv:type=\"Reference\">"
			+ "<sv:value>428c9ef2-78e5-4f1c-95d3-16b4ce72d815</sv:value>" + "</sv:property>"
			+ "<sv:node sv:name=\"rep:policy\">" + "<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\">"
			+ "<sv:value>rep:ACL</sv:value>" + "</sv:property>" + "<sv:node sv:name=\"allow\">"
			+ "<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\">" + "<sv:value>rep:GrantACE</sv:value>"
			+ "</sv:property>" + "<sv:property sv:name=\"rep:principalName\" sv:type=\"String\">"
			+ "<sv:value>everyone</sv:value>" + "</sv:property>"
			+ "<sv:property sv:name=\"rep:privileges\" sv:type=\"Name\">" + "<sv:value>jcr:write</sv:value>"
	...
	private static final String XML_POLICY_TREE_2 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			...
			+ "<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\">" + "<sv:value>rep:ACL</sv:value>"
			+ "</sv:property>" + "<sv:node sv:name=\"allow\">"
			+ "<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\">" + "<sv:value>rep:GrantACE</sv:value>"
			+ "</sv:property>" + "<sv:property sv:name=\"rep:principalName\" sv:type=\"String\">"
			+ "<sv:value>everyone</sv:value>" + "</sv:property>"
			+ "<sv:property sv:name=\"rep:privileges\" sv:type=\"Name\">" + "<sv:value>jcr:write</sv:value>"
			+ "</sv:property>" + "</sv:node>" + "</sv:node>";
	...
	private static final String XML_POLICY_TREE_3 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			...
			+ "<sv:value>everyone</sv:value>" + "</sv:property>"
			+ "<sv:property sv:name=\"rep:privileges\" sv:type=\"Name\">" + "<sv:value>jcr:write</sv:value>"
			+ "</sv:property>" + "</sv:node>" + "<sv:node sv:name=\"allow0\">"
			+ "<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\">" + "<sv:value>rep:GrantACE</sv:value>"
			+ "</sv:property>" + "<sv:property sv:name=\"rep:principalName\" sv:type=\"String\">"
			+ "<sv:value>admin</sv:value>" + "</sv:property>"
			+ "<sv:property sv:name=\"rep:privileges\" sv:type=\"Name\">" + "<sv:value>jcr:write</sv:value>"
			+ "</sv:property>" + "</sv:node>" + "</sv:node>";
	...
	private static final String XML_POLICY_TREE_4 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			...
			+ "<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\">" + "<sv:value>rep:GrantACE</sv:value>"
			+ "</sv:property>" + "<sv:property sv:name=\"rep:principalName\" sv:type=\"String\">"
			+ "<sv:value>unknownprincipal</sv:value>" + "</sv:property>"
			+ "<sv:property sv:name=\"rep:privileges\" sv:type=\"Name\">" + "<sv:value>jcr:write</sv:value>"
			+ "</sv:property>" + "</sv:node>" + "<sv:node sv:name=\"allow0\">"
			+ "<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\">" + "<sv:value>rep:GrantACE</sv:value>"
			+ "</sv:property>" + "<sv:property sv:name=\"rep:principalName\" sv:type=\"String\">"
	...
	private static final String XML_POLICY_TREE_5 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			...
			+ "xmlns:mix=\"http://www.jcp.org/jcr/mix/1.0\" xmlns:nt=\"http://www.jcp.org/jcr/nt/1.0\" xmlns:fn_old=\"http://www.w3.org/2004/10/xpath-functions\" xmlns:fn=\"http://www.w3.org/2005/xpath-functions\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:sv=\"http://www.jcp.org/jcr/sv/1.0\" xmlns:rep=\"internal\" xmlns:jcr=\"http://www.jcp.org/jcr/1.0\">"
			+ "<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\">" + "<sv:value>rep:ACL</sv:value>"
			+ "</sv:property>" + "<sv:node sv:name=\"allow0\">"
			+ "<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\">" + "<sv:value>rep:GrantACE</sv:value>"
			+ "</sv:property>" + "<sv:property sv:name=\"rep:principalName\" sv:type=\"String\">"
			+ "<sv:value>admin</sv:value>" + "</sv:property>"
			+ "<sv:property sv:name=\"rep:privileges\" sv:type=\"Name\">" + "<sv:value>jcr:write</sv:value>"
	...
	private static final String XML_REPO_POLICY_TREE = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			...
			+ "<sv:value>jcr:workspaceManagement</sv:value>" + "</sv:property>" + "</sv:node>" + "</sv:node>";
	...
	public void testImportACL() throws Exception {
		...
		try {
			...
			SessionImporter importer = new SessionImporter(target, sImpl,
					ImportUUIDBehavior.IMPORT_UUID_COLLISION_THROW, mockImportConfig1());
			ImportHandler ih = new ImportHandler(importer, sImpl);
			new ParsingContentHandler(ih).parse(in);
	...
	public void testImportACLRemoveACE() throws Exception {
		try {
			...
			importer = new SessionImporter(target, sImpl, ImportUUIDBehavior.IMPORT_UUID_COLLISION_THROW,
					mockImportConfig1());
	...
	public void testImportACLUnknownFail() throws Exception {
		try {
			...
			InputStream in = new ByteArrayInputStream(XML_POLICY_TREE_4.getBytes("UTF-8"));
			ImportConfig config = mockImportConfig1();
	...
	/**
	 * Make sure repo-level acl is not imported below any other node than the root
	 * node.
	 *
	 * @throws Exception
	 */
	...
	/**
	 * Imports a principal-based ACL containing a single entry mist fail with the
	...
	public void testImportPrincipalBasedACL() throws Exception {
		...
		if (!root.hasNode(AccessControlConstants.N_ACCESSCONTROL)) {
			target = root.addNode(AccessControlConstants.N_ACCESSCONTROL, AccessControlConstants.NT_REP_ACCESS_CONTROL,
					null);
		} else {
	...
	/**
	 * With the default importer that isn't able to deal with ACEs the policy will
	 * be created but any ACEs will be ignored.
	 *
	 * @throws Exception
	 */
	public void testImportWithDefaultImporter() throws Exception {
		...
		try {
			...
			SessionImporter importer = new SessionImporter(target, sImpl,
					ImportUUIDBehavior.IMPORT_UUID_COLLISION_THROW, null);
			ImportHandler ih = new ImportHandler(importer, sImpl);
			new ParsingContentHandler(ih).parse(in);
