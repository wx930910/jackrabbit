...
public class DiffParserTest extends TestCase {
	...
	public DiffHandler mockDiffHandler15() throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		return mockInstance;
	}

	public DiffHandler mockDiffHandler14(String value) throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			...
			return null;
		}).when(mockInstance).setProperty(Mockito.any(), Mockito.any());
		return mockInstance;
	}

	public DiffHandler mockDiffHandler13() throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler12(String value) throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler11(String value) throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler10(String value) throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler9(String value) throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler8() throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
			...
			return null;
		}).when(mockInstance).addNode(Mockito.any(), Mockito.any());
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
			...
			assertEquals("", diffValue);
			return null;
		}).when(mockInstance).remove(Mockito.any(), Mockito.any());
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
			...
			assertEquals("\n", diffValue);
			return null;
		}).when(mockInstance).move(Mockito.any(), Mockito.any());
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler7(String[] strs) throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler6(List<String> li) throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String diffValue = stubInvo.getArgument(1);
			li.add(diffValue);
	...
	public DiffHandler mockDiffHandler5() throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler4() throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler3() throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler2() throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler1() throws Exception {
		DiffHandler mockInstance = Mockito.mock(DiffHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String targetPath = stubInvo.getArgument(0);
			String diffValue = stubInvo.getArgument(1);
	...
	public void testSetProperty() throws IOException, DiffException, Exception {
	...
	public void testSetPropertyMissing() throws IOException, DiffException, Exception {
		ArrayList<String> l = new ArrayList<String>();
		l.add("");
		l.add(null);
	...
	public void testSetPropertyWithUnicodeChars() throws IOException, DiffException, Exception {
	...
	public void testSetPropertyWithTrailingLineSep() throws IOException, DiffException, Exception {
	...
	public void testSetPropertyWithSpecialChar() throws IOException, DiffException, Exception {
	...
	public void testSetPropertyUnterminatedString() throws IOException, DiffException, Exception {
		final String value = "\"String value ending with \r\r\n\n\r\n.";
		String diff = "^/a/prop : " + value;
	...
	public void testSetPropertyWithUnescapedAction() throws IOException, DiffException, Exception {
	...
	public void testValidDiffs() throws IOException, DiffException, Exception, Exception {
	...
	public void testSeparatorLines() throws IOException, DiffException, Exception, Exception, Exception, Exception {
		String diff = "+abc :\n\n+val : val";
	...
	public void testUnicodeLineSep() throws IOException, DiffException, Exception {
		String diff = "+abc : val" + new String(new byte[] { Character.LINE_SEPARATOR }, "utf-8") + "+abc : val";
		DiffHandler dh = mockDiffHandler1();
		new DiffParser(dh).parse(diff);
	}

	public void testInvalidDiff() throws IOException, DiffException, Exception {
		List<String> l = new ArrayList<String>();
		l.add("");
