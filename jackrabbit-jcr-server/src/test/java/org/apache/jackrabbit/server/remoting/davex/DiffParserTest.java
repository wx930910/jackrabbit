...
public class DiffParserTest extends TestCase {
	...
	public DiffHandler mockDiffHandler15() {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
	...
	public DiffHandler mockDiffHandler14(String value) {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
	...
	public DiffHandler mockDiffHandler13() {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String targetPath = stubInvo.getArgument(0);
	...
	public DiffHandler mockDiffHandler12(String value) {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String targetPath = stubInvo.getArgument(0);
	...
	public DiffHandler mockDiffHandler11(String value) {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String targetPath = stubInvo.getArgument(0);
	...
	public DiffHandler mockDiffHandler10(String value) {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String targetPath = stubInvo.getArgument(0);
	...
	public DiffHandler mockDiffHandler9(String value) {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String targetPath = stubInvo.getArgument(0);
	...
	public DiffHandler mockDiffHandler8() {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String targetPath = stubInvo.getArgument(0);
	...
	public DiffHandler mockDiffHandler7(String[] strs) {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String targetPath = stubInvo.getArgument(0);
	...
	public DiffHandler mockDiffHandler6(List<String> li) {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler5() {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String targetPath = stubInvo.getArgument(0);
	...
	public DiffHandler mockDiffHandler4() {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String diffValue = stubInvo.getArgument(1);
	...
	public DiffHandler mockDiffHandler3() {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String targetPath = stubInvo.getArgument(0);
	...
	public DiffHandler mockDiffHandler2() {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String targetPath = stubInvo.getArgument(0);
	...
	public DiffHandler mockDiffHandler1() {
		DiffHandler mockInstance = Mockito.spy(DiffHandler.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				String targetPath = stubInvo.getArgument(0);
