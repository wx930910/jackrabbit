...
public class JsonParserTest extends TestCase {
	...
	public JsonHandler mockJsonHandler12() throws IOException {
		...
		doAnswer((stubInvo) -> {
			...
			return null;
		}).when(mockInstance).key(any(String.class));
		doAnswer((stubInvo) -> {
			fail();
			return null;
	...
	public JsonHandler mockJsonHandler1(String expKey, String expValue) throws IOException {
		JsonHandler mockInstance = mock(JsonHandler.class);
		doAnswer((stubInvo) -> {
			String value = stubInvo.getArgument(0);
			assertEquals(expValue, value);
	...
	public void testParser6() throws Exception, IOException {
		...
		JsonHandler handler = mockJsonHandler1(expKey, expValue);
