...
public class JsonParserTest extends TestCase {
	...
	public JsonHandler mockJsonHandler12() throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
	...
	public JsonHandler mockJsonHandler11() throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			fail();
			return null;
	...
	public JsonHandler mockJsonHandler10() throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String key = stubInvo.getArgument(0);
	...
	public JsonHandler mockJsonHandler9() throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			fail();
			return null;
	...
	public JsonHandler mockJsonHandler8() throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			fail();
			return null;
	...
	public JsonHandler mockJsonHandler7() throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			fail();
			return null;
	...
	public JsonHandler mockJsonHandler6() throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String value = stubInvo.getArgument(0);
	...
	public JsonHandler mockJsonHandler5() throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			fail();
			return null;
	...
	public JsonHandler mockJsonHandler4() throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			fail();
			return null;
	...
	public JsonHandler mockJsonHandler3(String expValue) throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String value = stubInvo.getArgument(0);
	...
	public JsonHandler mockJsonHandler2() throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String value = stubInvo.getArgument(0);
			assertNull(value);
	...
	public JsonHandler mockJsonHandler1(String expValue, String expKey) throws Exception {
		JsonHandler mockInstance = Mockito.mock(JsonHandler.class);
		Mockito.doAnswer((stubInvo) -> {
			String key = stubInvo.getArgument(0);
